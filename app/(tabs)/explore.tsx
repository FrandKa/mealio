...
// import MapView, { Marker, Callout, PROVIDER_GOOGLE, Region } from 'react-native-web-maps';
import { useRouter } from 'expo-router';
import * as Location from 'expo-location';
import { Ionicons, MaterialCommunityIcons, FontAwesome5 } from '@expo/vector-icons';
import { debounce } from 'lodash'; // For debouncing map region changes
                                        ...
                                        <View style={styles.calloutTextContainer}>
                                            ...
                                            {restaurant['人均价格'] && (
                                                <View style={styles.calloutRow}>
                                                    <FontAwesome5 name="money-bill-wave" size={12} color={colors.textLight} style={styles.calloutIcon} />
                                            ...
                                            <View style={styles.calloutRow}>
                                                ...
                                                {restaurant['评论总数'] && (
                                                    <ThemedText style={[styles.calloutReviews, {color: colors.textLight}]}>
                                                        ({restaurant['评论总数']})
                                                    </ThemedText>
                                                )}
                                            </View>
