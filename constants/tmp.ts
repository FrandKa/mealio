...
// 新增的颜色
        ...
        cardBg: cardBg,
        borderColor: borderColor, // This is what we'll use for border
...
// 新增的颜色 (需要定义暗黑版本)
        ...
        secondary: '#E5E7EB', // 示例
        textLight: '#9CA3AF', // 示例 - This is what we'll use for textSubtle
        cardBg: '#1F2937', // 示例
        borderColor: '#374151', // 示例 - This is what we'll use for border
